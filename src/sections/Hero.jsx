...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="w-full flex xl:flex-row flex-col justify-center min-h-screen max-container gap-10 border-2"
    >
      ...
      <div className='flex sm:gap-6 gap-4 -bottom-[5%] absolute sm:left-[10%] max-sm:px-6'>
        {shoes.map((shoe) => (
          <div key={shoe}>
            <ShoeCard
              imgURL={shoe}
